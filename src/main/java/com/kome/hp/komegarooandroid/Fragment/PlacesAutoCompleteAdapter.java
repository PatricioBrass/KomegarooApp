...
public class PlacesAutoCompleteAdapter
    ...
    public PlacesAutoCompleteAdapter(Context context, int resource, GoogleApiClient googleApiClient,
                                     LatLngBounds bounds, AutocompleteFilter filter, ImageView v) {
        super(context, resource);
        mGoogleApiClient = googleApiClient;
        mBounds= new LatLngBounds(
                new LatLng(-33.4724728, -70.9100195),
                new LatLng(-33.4488897, -70.6692655));
        mPlaceFilter = new AutocompleteFilter.Builder()
                .setTypeFilter(Place.TYPE_COUNTRY).setCountry("CL")
                .setTypeFilter(Place.TYPE_SUBLOCALITY_LEVEL_1)
                .build();
        v = new ImageView(getContext());
        v.setImageResource(R.drawable.powered_by_google_on_white);
    }
